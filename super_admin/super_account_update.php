...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $check_query = "SELECT COUNT(*) FROM super_admin WHERE user_name = :user_name AND account_id != :account_id";
    ...
    if ($user_exists) {
        ...
        try {
            ...
            $update_stmt->bindParam(':password', $hashedPassword); // Save hashed password
...
<body>
    <div class="sidebar">
        ...
        <h3>Admin Account</h3>
        <button onclick="location.href='admin.php'"><i class="fa-solid fa-house"></i>‎ Dashboard</button>
        <button onclick="location.href='search.php'"><i class="fa-solid fa-file"></i>‎ ‎ Records</button>
        <button onclick="location.href='update_account.php?id=<?php echo $_SESSION['user_id']; ?>'" style="background-color: #1abc9c; color: white; border: none; border-radius: 5px; cursor: pointer;">
