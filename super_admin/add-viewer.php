...
<!-- Main Content -->
<div class="content">
        <h1>Add a Viewer Account</h1>

        <div class="desc">
        <h3><i class="fa-solid fa-circle-info"></i></h3>
        <p>The Viewer Account in the BERF Verification Tool allows authorized users to log in and access research data in the database. Viewers can browse, search, and view research documents but cannot edit, delete, or upload content. This account type is ideal for researchers, students, or stakeholders who need read-only access to published studies and reports.</p>
        </div>
