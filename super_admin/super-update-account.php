...
<body>
    <div class="sidebar">
        ...
        <button onclick="location.href='super-update-account.php?id=<?php echo $_SESSION['user_id']; ?>'" style="background-color: #1abc9c; color: white; border: none; border-radius: 5px; cursor: pointer;">
