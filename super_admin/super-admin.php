...
<div class="sidebar">
    ...
    <button onclick="location.href='super-admin.php'" style="background-color: #1abc9c; color: white; border: none; border-radius: 5px; cursor: pointer;">
    ...
    <button onclick="location.href='account.php'"><i class="fa-solid fa-user"></i></i></i>‎ ‎ Accounts</button>
    ...
    <table>
        ...
        <tbody>
            ...
            foreach ($data as $row) {
                ...
                echo "<a href='../super_admin/super-edit-record.php?id=$record_id'><button class='edit-btn'><i class='fa-solid fa-pen-to-square'></i></button></a> ";
                echo "<a href='../super_admin/super-delete-record.php?id=$record_id' onclick='return confirm(\"Are you sure you want to delete this record?\")'><button class='delete-btn'><i class='fa-solid fa-trash'></i></button></a>";
                echo "</td>";
                echo "</tr>";
                $counter++;
            }
