...
<div class="sidebar">
    ...
    <button onclick="location.href='../encoder/search.php'" style="background-color: #1abc9c; color: white; border: none; border-radius: 5px; cursor: pointer;">
    <i class="fa-solid fa-file"></i>‎ ‎ Records</button>
    <button onclick="location.href='../encoder/update_account.php?id=<?php echo $_SESSION['user_id']; ?>'">
    <i class="fa-solid fa-gear"></i> Account Settings</button>
    <button onclick="location.href='../encoder/logout.php'"><i class="fa-solid fa-right-from-bracket"></i>‎  Logout</button>
</div>
