...
try {
    ...
    $user_query = "SELECT first_name, last_name FROM encoder WHERE account_id = :account_id";
...
<div class="sidebar">
    ...
    <button onclick="location.href='../encoder/encoder.php'" style="background-color: #1abc9c; color: white; border: none; border-radius: 5px; cursor: pointer;">
